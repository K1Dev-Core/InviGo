...
<div class="neo-box w-full max-w-2xl mx-auto p-6 md:p-8">
    ...
    id="startDate"
    name="event_date" 
    class="neo-input w-full p-3 outline-none focus:shadow-[4px_4px_0px_0px_rgba(255,230,0,0.5)]"
    value="<?= isset($_POST['event_date']) ? sanitize($_POST['event_date']) : (isset($event['event_date']) ? date('Y-m-d\TH:i', strtotime($event['event_date'])) : '') ?>"
    required
>
...
window.addEventListener("load", syncEndDateLimit);
</script>
